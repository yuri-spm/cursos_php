...
-- Copiando dados para a tabela phptips.users: ~1 rows (aproximadamente)
DELETE FROM `users`;
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `first_name`, `last_name`, `email`, `password`, `created_at`, `updated_at`) VALUES
	(55, 'Elisangela', 'Monte', 'elisangela.monte@gmail.com', '$2y$10$tHyN26hejTK1t3ZzyaKL2e4130GPLH9QLK5OHGEoYN2sIQUUNxEc6', '2021-04-01 01:40:23', '2021-04-01 01:40:23');
